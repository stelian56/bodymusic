$(function() {
    ...
    var plotProps = {
        gyro: {
            ...
            maxValue: 6000,
            series: [
                {key: "x", name: "Gyro X", color: "green"},
                // {key: "y", name: "Gyro Y", color: "blue"},
                // {key: "z", name: "Gyro Z", color: "red"},
            ],
            scale: 1,
            unit: ""
        },
        // accelerometer: {
            ...
            // maxValue: 30000,
            // series: [
                // {key: "x", name: "Accelerometer X", color: "green"},
                // {key: "y", name: "Accelerometer Y", color: "blue"},
                // {key: "z", name: "Accelerometer Z", color: "red"},
            // ],
            // scale: 1,
            // unit: ""
        // },
        // compass: {
            ...
            // maxValue: 300,
            // series: [
                // {key: "x", name: "Compass X", color: "green"},
                // {key: "y", name: "Compass Y", color: "blue"},
                // {key: "z", name: "Compass Z", color: "red"},
            // ],
            // scale: 1,
            // unit: ""
        // }
    ...
    var plotHeight = 840 / varPropCount;
    ...
    var createStaff = function(sensorId) {
        var staffElementId = "Sensor" + sensorId;
        $staffElement = $("<div/>", {
            id: staffElementId,
        ...
        staffs[sensorId] = staff;
    };

    var updateStaff = function(note) {
        var staff = staffs[note.sensorId];
                ...
                $plotElement.mousemove(function(event) {
                    ...
                    if (strokeIndex > -1 && strokeIndex < history.length) {
                        ...
                        $.each(plot.series, function() {
                            var value = sensorData[plotKey][this.key] * thisPlotProps.scale;
                            tooltipText += "<br>" + this.name + ": " +
                                value.toFixed(0) + " " + thisPlotProps.unit;
                        });
    ...
    var createPlots = function() {
        $.each(sensorIds, function() {
            var sensorId = this;
            createStaff(sensorId);
